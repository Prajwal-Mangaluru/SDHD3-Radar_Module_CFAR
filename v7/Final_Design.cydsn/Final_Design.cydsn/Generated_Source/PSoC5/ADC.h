...
#define ADC__BITS_9 9
#define ADC__BITS_10 10
#define ADC__BITS_11 11
#define ADC__BITS_12 12
#define ADC__BITS_13 13
#define ADC__BITS_14 14
#define ADC__BITS_15 15
#define ADC__BITS_16 16
#define ADC__BITS_17 17
#define ADC__BITS_18 18
#define ADC__BITS_19 19
#define ADC__BITS_20 20
...
/* Trim value defines */
#define ADC_DEC_TRIM_VREF_DIFF_8_15        (int8)(CY_GET_XTND_REG8(ADC_DEC__TRIM__M5))
#define ADC_DEC_TRIM_VREF_DIFF_16_20       (int8)(CY_GET_XTND_REG8(ADC_DEC__TRIM__M1))
#define ADC_DEC_TRIM_VREF_2_DIFF_8_15      (int8)(CY_GET_XTND_REG8(ADC_DEC__TRIM__M6))
#define ADC_DEC_TRIM_VREF_2_DIFF_16_20     (int8)(CY_GET_XTND_REG8(ADC_DEC__TRIM__M2))
#define ADC_DEC_TRIM_VREF_4_DIFF_8_15      (int8)(CY_GET_XTND_REG8(ADC_DEC__TRIM__M7))
#define ADC_DEC_TRIM_VREF_4_DIFF_16_20     (int8)(CY_GET_XTND_REG8(ADC_DEC__TRIM__M3))
#define ADC_DEC_TRIM_VREF_16_DIFF_8_15     (int8)(CY_GET_XTND_REG8(ADC_DEC__TRIM__M8))
#define ADC_DEC_TRIM_VREF_16_DIFF_16_20    (int8)(CY_GET_XTND_REG8(ADC_DEC__TRIM__M4))

#define ADC_PRES_DELAY_TIME                (3u)        /* 3 us */

#define ADC_1V_COUNTS                      (1.0F)
#define ADC_1MV_COUNTS                     (1000)
#define ADC_1UV_COUNTS                     (1000000L)
#define ADC_DIVISOR_1                      (1)
#define ADC_DIVISOR_2                      (2)
#define ADC_DIVISOR_4                      (4)
#define ADC_DIVISOR_8                      (8)
#define ADC_DIVISOR_16                     (16)
#define ADC_DIVISOR_32                     (32)
#define ADC_DIVISOR_64                     (64)
#define ADC_DIVISOR_125                    (125)
#define ADC_DIVISOR_250                    (250)
#define ADC_DIVISOR_500                    (500)
...
extern volatile uint8 ADC_convDone;
extern volatile uint8 ADC_stopConversion;
extern volatile uint8 ADC_started;
extern volatile uint8 ADC_Config;
extern volatile int32 ADC_Offset;
extern volatile int32 ADC_CountsPerVolt;
...
#define ADC_DSM_DEM1_MASK              (0xFFu)
...
#define ADC_DEC_OCOR_EN                (0x20u) /* Offset correction enable */
...
#define ADC_DEC_CR_SR_16B_PTR        ( (reg16 *) ADC_DEC__CR )
...
#define ADC_DEC_SHIFT_16B_PTR        ( (reg16 *) ADC_DEC__SHIFT1 )
...
#define ADC_DEC_DR2_16B_PTR          ( (reg16 *) ADC_DEC__DR2 )
...
#define ADC_DEC_DR1_16B_PTR          ( (reg16 *) ADC_DEC__DR1 )

#define ADC_DEC_OCOR_REG             (* (reg8 *) ADC_DEC__OCOR )
#define ADC_DEC_OCOR_PTR             (  (reg8 *) ADC_DEC__OCOR )
#define ADC_DEC_OCOR_16B_PTR         ( (reg16 *) ADC_DEC__OCOR )
...
#define ADC_DEC_SAMP_16B_PTR         ( (reg16 *) ADC_DEC__OUTSAMP )
...
#define ADC_DEC_SAMPH_16B_PTR        ( (reg16 *) ADC_DEC__OUTSAMPH )

#define ADC_DEC_COHER_REG            (* (reg8 *) ADC_DEC__COHER )
#define ADC_DEC_COHER_PTR            (  (reg8 *) ADC_DEC__COHER )
#define ADC_DEC_COHER_16B_PTR        ( (reg16 *) ADC_DEC__COHER )
...
#define ADC_DSM_CR0_REG              (* (reg8 *) ADC_DSM__CR0 )
#define ADC_DSM_CR0_PTR              (  (reg8 *) ADC_DSM__CR0 )

#define ADC_DSM_CR1_REG              (* (reg8 *) ADC_DSM__CR1 )
#define ADC_DSM_CR1_PTR              (  (reg8 *) ADC_DSM__CR1 )

#define ADC_DSM_CR2_REG              (* (reg8 *) ADC_DSM__CR2 )
#define ADC_DSM_CR2_PTR              (  (reg8 *) ADC_DSM__CR2 )

#define ADC_DSM_CR3_REG              (* (reg8 *) ADC_DSM__CR3 )
#define ADC_DSM_CR3_PTR              (  (reg8 *) ADC_DSM__CR3 )

#define ADC_DSM_CR4_REG              (* (reg8 *) ADC_DSM__CR4 )
#define ADC_DSM_CR4_PTR              (  (reg8 *) ADC_DSM__CR4 )

#define ADC_DSM_CR5_REG              (* (reg8 *) ADC_DSM__CR5 )
#define ADC_DSM_CR5_PTR              (  (reg8 *) ADC_DSM__CR5 )

#define ADC_DSM_CR6_REG              (* (reg8 *) ADC_DSM__CR6 )
#define ADC_DSM_CR6_PTR              (  (reg8 *) ADC_DSM__CR6 )

#define ADC_DSM_CR7_REG              (* (reg8 *) ADC_DSM__CR7 )
#define ADC_DSM_CR7_PTR              (  (reg8 *) ADC_DSM__CR7 )

#define ADC_DSM_CR8_REG              (* (reg8 *) ADC_DSM__CR8 )
#define ADC_DSM_CR8_PTR              (  (reg8 *) ADC_DSM__CR8 )

#define ADC_DSM_CR9_REG              (* (reg8 *) ADC_DSM__CR9 )
#define ADC_DSM_CR9_PTR              (  (reg8 *) ADC_DSM__CR9 )

#define ADC_DSM_CR10_REG             (* (reg8 *) ADC_DSM__CR10 )
#define ADC_DSM_CR10_PTR             (  (reg8 *) ADC_DSM__CR10 )

#define ADC_DSM_CR11_REG             (* (reg8 *) ADC_DSM__CR11 )
#define ADC_DSM_CR11_PTR             (  (reg8 *) ADC_DSM__CR11 )

#define ADC_DSM_CR12_REG             (* (reg8 *) ADC_DSM__CR12 )
#define ADC_DSM_CR12_PTR             (  (reg8 *) ADC_DSM__CR12 )

#define ADC_DSM_CR13_REG             (* (reg8 *) ADC_DSM__CR13 )
#define ADC_DSM_CR13_PTR             (  (reg8 *) ADC_DSM__CR13 )

#define ADC_DSM_CR14_REG             (* (reg8 *) ADC_DSM__CR14 )
#define ADC_DSM_CR14_PTR             (  (reg8 *) ADC_DSM__CR14 )

#define ADC_DSM_CR15_REG             (* (reg8 *) ADC_DSM__CR15 )
#define ADC_DSM_CR15_PTR             (  (reg8 *) ADC_DSM__CR15 )

#define ADC_DSM_CR16_REG             (* (reg8 *) ADC_DSM__CR16 )
#define ADC_DSM_CR16_PTR             (  (reg8 *) ADC_DSM__CR16 )

#define ADC_DSM_CR17_REG             (* (reg8 *) ADC_DSM__CR17 )
#define ADC_DSM_CR17_PTR             (  (reg8 *) ADC_DSM__CR17 )

#define ADC_DSM_REF0_REG             (* (reg8 *) ADC_DSM__REF0 )
#define ADC_DSM_REF0_PTR             (  (reg8 *) ADC_DSM__REF0 )

#define ADC_DSM_REF1_REG             (* (reg8 *) ADC_DSM__REF1 )
#define ADC_DSM_REF1_PTR             (  (reg8 *) ADC_DSM__REF1 )

#define ADC_DSM_REF2_REG             (* (reg8 *) ADC_DSM__REF2 )
#define ADC_DSM_REF2_PTR             (  (reg8 *) ADC_DSM__REF2 )

#define ADC_DSM_REF3_REG             (* (reg8 *) ADC_DSM__REF3 )
#define ADC_DSM_REF3_PTR             (  (reg8 *) ADC_DSM__REF3 )

#define ADC_DSM_DEM0_REG             (* (reg8 *) ADC_DSM__DEM0 )
#define ADC_DSM_DEM0_PTR             (  (reg8 *) ADC_DSM__DEM0 )

#define ADC_DSM_DEM1_REG             (* (reg8 *) ADC_DSM__DEM1 )
#define ADC_DSM_DEM1_PTR             (  (reg8 *) ADC_DSM__DEM1 )

#define ADC_DSM_MISC_REG             (* (reg8 *) ADC_DSM__MISC )
#define ADC_DSM_MISC_PTR             (  (reg8 *) ADC_DSM__MISC )

#define ADC_DSM_CLK_REG              (* (reg8 *) ADC_DSM__CLK )
#define ADC_DSM_CLK_PTR              (  (reg8 *) ADC_DSM__CLK )

#define ADC_DSM_TST0_REG             (* (reg8 *) ADC_DSM__TST0 )
#define ADC_DSM_TST0_PTR             (  (reg8 *) ADC_DSM__TST0 )

#define ADC_DSM_TST1_REG             (* (reg8 *) ADC_DSM__TST1 )
#define ADC_DSM_TST1_PTR             (  (reg8 *) ADC_DSM__TST1 )

#define ADC_DSM_BUF0_REG             (* (reg8 *) ADC_DSM__BUF0 )
#define ADC_DSM_BUF0_PTR             (  (reg8 *) ADC_DSM__BUF0 )

#define ADC_DSM_BUF1_REG             (* (reg8 *) ADC_DSM__BUF1 )
#define ADC_DSM_BUF1_PTR             (  (reg8 *) ADC_DSM__BUF1 )

#define ADC_DSM_BUF2_REG             (* (reg8 *) ADC_DSM__BUF2 )
#define ADC_DSM_BUF2_PTR             (  (reg8 *) ADC_DSM__BUF2 )

#define ADC_DSM_BUF3_REG             (* (reg8 *) ADC_DSM__BUF3 )
#define ADC_DSM_BUF3_PTR             (  (reg8 *) ADC_DSM__BUF3 )

#define ADC_DSM_OUT0_REG             (* (reg8 *) ADC_DSM__OUT0 )
#define ADC_DSM_OUT0_PTR             (  (reg8 *) ADC_DSM__OUT0 )

#define ADC_DSM_OUT1_REG             (* (reg8 *) ADC_DSM__OUT1 )
#define ADC_DSM_OUT1_PTR             (  (reg8 *) ADC_DSM__OUT1 )

#define ADC_DSM_SW0_REG              (* (reg8 *) ADC_DSM__SW0 )
#define ADC_DSM_SW0_PTR              (  (reg8 *) ADC_DSM__SW0 )

#define ADC_DSM_SW2_REG              (* (reg8 *) ADC_DSM__SW2 )
#define ADC_DSM_SW2_PTR              (  (reg8 *) ADC_DSM__SW2 )

#define ADC_DSM_SW3_REG              (* (reg8 *) ADC_DSM__SW3 )
#define ADC_DSM_SW3_PTR              (  (reg8 *) ADC_DSM__SW3 )

#define ADC_DSM_SW4_REG              (* (reg8 *) ADC_DSM__SW4 )
#define ADC_DSM_SW4_PTR              (  (reg8 *) ADC_DSM__SW4 )

#define ADC_DSM_SW6_REG              (* (reg8 *) ADC_DSM__SW6 )
#define ADC_DSM_SW6_PTR              (  (reg8 *) ADC_DSM__SW6 )
...
/* Default Config
* ADC_CFG1 Sample Rate: 2000 Samples per Second
...
#define ADC_CFG1_DSM_DEM0           (0x04u)
...
#define ADC_CFG1_CLOCK_FREQ         (128000u)
...
#define ADC_CFG1_ADC_CLK_DIVIDER    (186u)
...
#define ADC_CFG1_BUF_GAIN           ADC_CFG1_BUFFER_GAIN
#define ADC_CFG1_RANGE              ADC_CFG1_INPUT_RANGE
#define ADC_CFG1_RANGE_VALUE        ADC_CFG1_INPUT_RANGE_VALUE
...
#define ADC_CFG2_DEC_SHIFT2         (0x07u)
#define ADC_CFG2_DEC_DIV            (0)
...
#define ADC_CFG2_DSM_CR8            (0x5Bu)
#define ADC_CFG2_DSM_CR9            (0x5Eu)
...
#define ADC_CFG2_COUNTS_PER_VOLT    (32000)
#define ADC_CFG2_RESOLUTION         (16u)
#define ADC_CFG2_CONV_MODE          (2u)
#define ADC_CFG2_IDEAL_DEC_GAIN     (0x90DAu)
#define ADC_CFG2_INPUT_RANGE        (4u)
...
*   just to keep the component backward compatible
*/
#define ADC_CFG2_CONVMODE           ADC_CFG2_CONV_MODE
#define ADC_CFG2_INPUT_MODE         ADC_DEFAULT_INPUT_MODE
...
#define ADC_CFG3_DEC_SHIFT2         (0x07u)
#define ADC_CFG3_DEC_DIV            (0)
...
#define ADC_CFG3_DSM_CR8            (0x5Bu)
#define ADC_CFG3_DSM_CR9            (0x5Eu)
...
#define ADC_CFG3_COUNTS_PER_VOLT    (32000)
#define ADC_CFG3_RESOLUTION         (16u)
#define ADC_CFG3_CONV_MODE          (2u)
#define ADC_CFG3_IDEAL_DEC_GAIN     (0x90DAu)
#define ADC_CFG3_INPUT_RANGE        (4u)
...
*   just to keep the component backward compatible
*/
#define ADC_CFG3_CONVMODE           ADC_CFG3_CONV_MODE
#define ADC_CFG3_INPUT_MODE         ADC_DEFAULT_INPUT_MODE
...
#define ADC_CFG4_DEC_SHIFT2         (0x07u)
#define ADC_CFG4_DEC_DIV            (0)
...
#define ADC_CFG4_DSM_CR8            (0x5Bu)
#define ADC_CFG4_DSM_CR9            (0x5Eu)
...
#define ADC_CFG4_COUNTS_PER_VOLT    (32000)
#define ADC_CFG4_RESOLUTION         (16u)
#define ADC_CFG4_CONV_MODE          (2u)
#define ADC_CFG4_IDEAL_DEC_GAIN     (0x90DAu)
#define ADC_CFG4_INPUT_RANGE        (4u)
...
*   just to keep the component backward compatible
*/
#define ADC_CFG4_CONVMODE           ADC_CFG4_CONV_MODE
#define ADC_CFG4_INPUT_MODE         ADC_DEFAULT_INPUT_MODE
