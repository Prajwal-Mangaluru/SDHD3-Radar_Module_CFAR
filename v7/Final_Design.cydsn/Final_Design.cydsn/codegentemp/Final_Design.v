...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\demux_v1_10"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\demux_v1_10\demux_v1_10.v"
`else
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\demux_v1_10"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\demux_v1_10\demux_v1_10.v"
`endif
...
module WaveDAC8_v2_10_1 (
	...
	cy_clock_v1_0
		#(.id("cfb896ca-fe95-40e6-b731-157e61fb9f7d/77086516-855e-4b7b-abbe-47b22f8543de"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_constant_v1_0"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_constant_v1_0\cy_constant_v1_0.v"
`else
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_constant_v1_0"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_constant_v1_0\cy_constant_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_vref_v1_70"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_vref_v1_70\cy_vref_v1_70.v"
`else
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_vref_v1_70"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_vref_v1_70\cy_vref_v1_70.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\AMux_v1_80"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\AMux_v1_80\AMux_v1_80.v"
`else
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\AMux_v1_80"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\AMux_v1_80\AMux_v1_80.v"
`endif
...
module ADC_DelSig_v3_30_2 (
	...
	cy_clock_v1_0
		#(.id("aec0db50-20d5-493a-9e12-9440255c1c1b/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("aec0db50-20d5-493a-9e12-9440255c1c1b/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
`ifdef WARP
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_UART_v2_50"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_UART_v2_50\B_UART_v2_50.v"
`else
`define CY_BLK_DIR "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_UART_v2_50"
`include "D:\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_UART_v2_50\B_UART_v2_50.v"
`endif
...
module top ;
	...
	wire [0:0] tmpOE__DACout_net;
	wire [0:0] tmpFB_0__DACout_net;
	wire [0:0] tmpIO_0__DACout_net;
	wire [0:0] tmpINTERRUPT_0__DACout_net;
	electrical [0:0] tmpSIOVREF__DACout_net;
	...
	cy_psoc3_pins_v1_10
		...
		DACout
		 (.oe(tmpOE__DACout_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DACout_net[0:0]}),
		  .analog({Net_7}),
		  .io({tmpIO_0__DACout_net[0:0]}),
		  .siovref(tmpSIOVREF__DACout_net),
		  .interrupt({tmpINTERRUPT_0__DACout_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DACout_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("a7888f83-5b86-4dd0-9f80-b298a814dcf0"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__led_orange_net;
	wire [0:0] tmpFB_0__led_orange_net;
	wire [0:0] tmpIO_0__led_orange_net;
	wire [0:0] tmpINTERRUPT_0__led_orange_net;
	electrical [0:0] tmpSIOVREF__led_orange_net;

	cy_psoc3_pins_v1_10
		#(.id("0e7ef2dc-b596-4dee-80f6-873088205004"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		led_orange
		 (.oe(tmpOE__led_orange_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__led_orange_net[0:0]}),
		  .io({tmpIO_0__led_orange_net[0:0]}),
		  .siovref(tmpSIOVREF__led_orange_net),
		  .interrupt({tmpINTERRUPT_0__led_orange_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__led_orange_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("aab62f5f-c09d-4d92-8c94-e25efa80a8bc"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 D_red (
        .connect({
            Net_16,
            Net_23
        })
    );
    defparam D_red.comp_name = "LED_v1_0";
    defparam D_red.port_names = "A, K";
    defparam D_red.width = 2;

    cy_annotation_universal_v1_0 D_orange (
        .connect({
            Net_19,
            Net_24
        })
    );
    defparam D_orange.comp_name = "LED_v1_0";
    defparam D_orange.port_names = "A, K";
    defparam D_orange.width = 2;

    cy_annotation_universal_v1_0 D_green (
        .connect({
            Net_22,
            Net_25
        })
    );
    defparam D_green.comp_name = "LED_v1_0";
    defparam D_green.port_names = "A, K";
    defparam D_green.width = 2;
